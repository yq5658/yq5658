...
public class SettingsController
{
    ...
    public String qrcode(Model model)
    {
        ...
        model.addAttribute("alipay",
                settingService.getValueByCode(Constant.ALIPAY));
        model.addAttribute("wechat",
                settingService.getValueByCode(Constant.WECHAT_PAY));
